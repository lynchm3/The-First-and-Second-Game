...
public class art {
	 ...
	 * 
	 ...
	 filters->other->high pass, blending mode overlay, 
	 new colour lookup adjustment layer, teal other plus contract (or something like that),
	 opacity ~50
	 
	 try grimey->then cartoon->then grimey again :D
	 
	 ->cutout
	 just using cutout on photos looks really well :P
	 
	 Try drawing ur own spritess, or based on other sprites(draw over other sprites)(look for tutorial for creating ur own sprites)
