	...
	public void draw() {
		...
		if (enabled) {
			if (down) {
				...
				TextUtils.printTextWithImages(x, y, Integer.MAX_VALUE, true, null, Color.WHITE, 1f, new Object[] { text });
			} else {
				QuadUtils.drawQuad(Color.DARK_GRAY, x, y, x + width, y + height);
				TextUtils.printTextWithImages(x, y, 200, false, null, Color.WHITE, 1f, new Object[] { text });
			}
		} else {
