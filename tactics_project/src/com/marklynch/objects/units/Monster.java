...
public class Monster extends Actor {
	...
	public Monster(String name, String title, int actorLevel, int health, int strength, int dexterity, int intelligence,
			...
			GameObject bed, Inventory inventory, boolean canOpenDoors, boolean canEquipWeapons, float widthRatio,
			...
			float legsAnchorY, GameObject[] mustHaves, GameObject[] mightHaves, int templateId) {
