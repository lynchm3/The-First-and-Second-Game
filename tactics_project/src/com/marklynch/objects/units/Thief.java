...
public class Thief extends Actor {
	...
	public Thief(String name, String title, int actorLevel, int health, int strength, int dexterity, int intelligence,
	...
	@Override
	public Thief makeCopy(Square square, Faction faction, GameObject bed, int gold) {
