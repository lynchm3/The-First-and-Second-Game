...
public class CarnivoreNeutralWildAnimal extends Actor {
	...
	public CarnivoreNeutralWildAnimal(String name, String title, int actorLevel, int health, int strength,
			...
			int travelDistance, int sight, Bed bed, Inventory inventory, boolean showInventory, boolean fitsInInventory,
	...
	public CarnivoreNeutralWildAnimal makeCopy(String name, Square square, Faction faction, Bed bed, Area area) {
