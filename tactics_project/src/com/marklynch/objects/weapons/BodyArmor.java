...
public class BodyArmor extends GameObject {
	...
	public BodyArmor(String name, String imagePath, float health, Square squareGameObjectIsOn, boolean fitsInInventory,
			...
			float fireResistance, float waterResistance, float electricResistance, float poisonResistance, float weight, Actor owner,
	...
	public BodyArmor makeCopy(Square square, Actor owner) {
		return new BodyArmor(new String(name), imageTexturePath, totalHealth, square, fitsInInventory,
