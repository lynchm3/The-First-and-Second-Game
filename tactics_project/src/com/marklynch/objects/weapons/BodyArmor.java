...
public class BodyArmor extends GameObject {
	...
	public BodyArmor(String name, String imagePath, float health, Square squareGameObjectIsOn, float widthRatio,
	...
	public BodyArmor makeCopy(Square square, Actor owner) {
		return new BodyArmor(new String(name), imageTexturePath, totalHealth, square, widthRatio, heightRatio,
				drawOffsetX, drawOffsetY, soundWhenHit, soundWhenHitting, soundDampening, light, lightHandleX,
				lightHandlY, stackable, fireResistance, waterResistance, electricResistance, poisonResistance,
