...
public class Lantern extends Tool {
	...
	public Lantern(String name, float slashDamage, float pierceDamage, float bluntDamage, float fireDamage,
	...
	public Lantern makeCopy(Square square, Actor owner) {
		return new Lantern(new String(name), slashDamage, pierceDamage, bluntDamage, fireDamage, waterDamage,
