...
public class Knife extends Tool {
	...
	public Knife(String name, float minRange, float maxRange, String imagePath, float health,
			...
			float weight, Actor owner, float anchorX, float anchorY) {
	...
	public Knife makeCopy(Square square, Actor owner) {
		return new Knife(new String(name), minRange, maxRange, imageTexturePath, totalHealth, square, fitsInInventory,
				canContainOtherObjects, blocksLineOfSight, persistsWhenCantBeSeen, widthRatio, heightRatio, drawOffsetX,
				drawOffsetY, soundWhenHit, soundWhenHitting, soundDampening, light, lightHandleX, lightHandlY,
				stackable, fireResistance, waterResistance, electricResistance, poisonResistance, slashResistance,
