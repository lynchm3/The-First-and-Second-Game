...
public class Knife extends Tool {
	...
	public Knife(String name, float slashDamage, float pierceDamage, float bluntDamage, float fireDamage,
	...
	public Knife makeCopy(Square square, Actor owner) {
		return new Knife(new String(name), slashDamage, pierceDamage, bluntDamage, fireDamage, waterDamage,
