...
public class Arrow extends GameObject {
	...
	public Arrow(String name, int health, String imagePath, Square squareGameObjectIsOn, Inventory inventory,
			...
			float electricResistance, float poisonResistance, float weight, Actor owner) {
		super(name, health, imagePath, squareGameObjectIsOn, inventory, showInventory, canShareSquare, fitsInInventory,
				canContainOtherObjects, blocksLineOfSight, persistsWhenCantBeSeen, true, widthRatio,
				heightRatio, soundHandleX, soundHandleY, soundWhenHit, soundWhenHitting, soundDampening, light, lightHandleX, lightHandlY,
	...
	public Arrow makeCopy(Square square, Actor owner) {
		return new Arrow(new String(name), (int) totalHealth, imageTexturePath, square, inventory.makeCopy(),
				...
				electricResistance, poisonResistance, weight, owner);
	}
