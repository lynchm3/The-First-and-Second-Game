...
public class Templates {
	...
	public static final Player Player = new Player("You", "Fighter", 10, 100, 10, 0, 0, 0, "red1.png", null, 1, 10,
			...
			false, 0f, 0f, 0f, 0f, 90f, null, null, 80f, 80f, 73f, 22f, 80f, 80f, 80f, 80f);
	...
	public static final Pig PIG = new Pig("Pig", "Pig", 1, 10, 0, 0, 0, 0, "pig.png", null, 1, 10, null,
			new Inventory(), true, false, true, false, false, 1f, 0.65625f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f,
			false, 0f, 0f, 0f, 0f, 90f, null, null, 40, 96, 40, 96, 40, 96, 40, 96);
	...
	public static final Weapon HATCHET = new Weapon("Hatchet", 3, 1, 1, "a3r1.png", 100, null, true, false, false,
			false, 0.5f, 0.5f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 3f, null, 24, 40);
	...
	public static final Weapon HUNTING_BOW = new Weapon("Hunting Bow", 1, 1, 10, "a2r2.png", 100, null, true, false,
			false, false, 0.5f, 0.5f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 3f, null, 40,
			42);

	// ARMOUR
	// Helmets
	public static final Helmet HARD_HAT = new Helmet("Hard Hat", "hard_hat.png", 100, null, true, false, false, false,
			0.5f, 0.25f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 3f, null, 16, 24);
	public static final Helmet PINK_HARD_HAT = new Helmet("Hard Hat", "pink_hard_hat.png", 100, null, true, false,
			false, false, 0.5f, 0.25f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 3f, null, 16,
			24);

	// Furniture
	public static final Bed BED = new Bed("Bed", 5, "bed.png", "bed_Covers.png", null, new Inventory(), false, true,
			false, false, false, false, 1, 1, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 75f,
			null);
	public static final GameObjectTemplate SHOP_COUNTER = new GameObjectTemplate("Shop Counter", 5, "shop_counter.png",
			null, new Inventory(), false, true, false, true, false, false, true, 1f, 1f, 0.5f, 0.5f, 1f, 1f, 1f, null,
			0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 100f);
	public static final GameObjectTemplate TABLE = new GameObjectTemplate("Table", 5, "table.png", null,
			new Inventory(), true, false, false, true, false, false, true, 1f, 1f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f,
			0.5f, false, 0f, 0f, 0f, 0f, 20f);
	...
	public static final GameObjectTemplate BARRICADE = new GameObjectTemplate("BARRICADE", 25, "barricade.png", null,
			new Inventory(), false, false, false, false, false, true, true, 1f, 1f, 0.5f, 0.5f, 10f, 1f, 1f, null, 0.5f,
	...
	public static final Readable ROCK_WITH_ETCHING = new Readable("Rock with Etching", 1000, "rock_with_etching.png",
			...
			1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 100f, null);
	...
	public static final Key KEY = new Key("Key", 10, "key.png", null, new Inventory(), false, true, true, false, false,
			true, 0.3f, 0.3f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0.5f, null);
	public static final GameObject PLATE = new Stampable("Plate", 10, "plate.png", null, new Inventory(), false, true,
			true, false, false, true, 0.5f, 0.5f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0.5f,
			null);
	public static final GameObject BROKEN_PLATE = new Stampable("Broken Plate", 10, "broken_plate.png", null,
			...
			0.5f, false, 0f, 0f, 0f, 0f, 0.5f, null);
	public static final GameObject DINNER_KNIFE = new GameObject("Dinner Knife", 10, "knife.png", null, new Inventory(),
			false, true, true, false, false, true, true, 0.5f, 0.125f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false,
			0f, 0f, 0f, 0f, 0.5f, null);
	...
	public static final GameObject BOULDER = new GameObject("Boulder", 1000, "boulder.png", null, new Inventory(),
			false, false, false, false, true, true, true, 1, 1, 0.5f, 0.5f, 15f, 0f, 10f, null, 0.5f, 0.5f, false, 0f,
			0f, 0f, 0f, 200f, null);
	public static final Arrow ARROW = new Arrow("Arrow", 5, "arrow.png", null, new Inventory(), false, true, true,
			false, false, false, 0.32f, 0.16f, 0.5f, 0.5f, 15f, 0f, 10f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0.1f,
			null);
	public static final GameObject ROCK = new GameObject("Stone", 1000, "rock.png", null, new Inventory(), false, true,
			true, false, false, false, true, 0.32f, 0.32f, 0.5f, 0.5f, 15f, 0f, 10f, null, 0.5f, 0.5f, false, 0f, 0f,
			0f, 0f, 100f, null);
	...
	public static final Carcass CARCASS = new Carcass("Carcass", 5, "carcass.png", null, new Inventory(), false, true,
			false, true, false, false, 0.5f, 0.5f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0f,
			null);
	...
	public static final Junk FUR = new Junk("Fur", 5, "fur.png", null, new Inventory(), false, true, true, false, false,
			false, 1, 1, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 5f, null);
	...
	public static final Junk ORE = new Junk("Ore", 5, "ore.png", null, new Inventory(), false, true, true, false, false,
			false, 0.25f, 0.25f, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 5f, null);
	public static final Junk BLOOD = new Junk("Blood", 5, "blood.png", null, new Inventory(), false, true, false, false,
			false, false, 1, 1, 0.5f, 0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0.1f, null);
