...
public class Templates {
	...
	public Templates() {
		...
		// Player
		Player = new Player("You", "Fighter", 1, 100, 10, 0, 0, 0, "hero.png", null, 1, 10, null, new Inventory(), 1f,
				1.5f, 0f, -0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0f, 90f, null, null, 75f, 127f,
				70f, 23f, 0f, 0f, 0f, 0f, 0, new GameObject[] {}, new GameObject[] {},
		...
		BLIND = new Blind("Blind", "Blind", 1, 10, 0, 0, 0, 0, "blind.png", null, 1, 1, null, new Inventory(), 1f, 1f,
				0, 0, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 0f, 50f, null, null, 88, 54, 88, 54, 88, 54,
				88, 54, null, new GameObject[] {}, new GameObject[] {}, GameObject.generateNewTemplateId());

		ROCK_GOLEM = new RockGolem("Rock Golem", "Rock Golem", 1, 100, 0, 0, 0, 0, "rock_golem.png", null, 1, 10, null,
				new Inventory(), 1, 1.5f, 0, -0.5f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 90f, 0f, 0f, 0f, 100f, 150f,
				null, null, 88, 54, 88, 54, 88, 54, 88, 54, null, false, new GameObject[] {}, new GameObject[] {},
				GameObject.generateNewTemplateId());
