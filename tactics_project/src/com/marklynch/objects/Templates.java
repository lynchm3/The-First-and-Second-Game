...
public class Templates {
	...
	public static final Gate GATE = new Gate("Gate", 100, "gate.png", null, new Inventory(), 1, 1, 0f, 0f, 1f, 1f, 10f,
			...
			GameObject.generateNewTemplateId());
	public static final Storage CHEST = new Storage("Chest", 200, "chest.png", "chest_open.png", null, new Inventory(), 1,
			1, 0f, 0f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 100f, 25f, 135, null, false,
			GameObject.generateNewTemplateId());
	public static final Storage CRATE = new Storage("Crate", 200, "crate.png", "crate_open.png", null, new Inventory(), 1,
			1, 0f, 0f, 1f, 1f, 1f, null, 0.5f, 0.5f, false, 0f, 0f, 0f, 0f, 100f, 25f, 135, null, false,
			GameObject.generateNewTemplateId());
