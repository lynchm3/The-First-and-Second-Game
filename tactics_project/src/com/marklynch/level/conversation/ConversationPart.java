...
public class ConversationPart {
	...
	public void drawStaticUI1() {
			...
			for (Actor actor : talker.group.getMembers()) {
				...
				if (actor == Game.level.conversation.originalConversationTarget) {
					...
					actor.drawActor(0 + offsetX, (int) Game.halfWindowHeight + offsetY, 1f, false, 2f, 2f,
							Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, TextureUtils.neutralColor);
			...
			if (originalTarget != null && talker != originalTarget) {
				...
				if (originalTarget instanceof Human) {
					((Actor) Game.level.conversation.originalConversationTarget).drawActor(0 + offsetX,
							...
							Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, TextureUtils.neutralColor);
		...
		Game.level.player.drawActor((int) (Game.windowWidth - Game.halfWindowHeight), (int) Game.halfWindowHeight, 1f,
				false, 2f, 2f, Integer.MIN_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, TextureUtils.neutralColor);
