...
public class AreaTownForest {
	...
	public static void createForest() {
		...
		new Group("Buns",
				...
				Templates.RABBIT.makeCopy("Male Bun", Game.level.squares[182][62], Game.level.factions.buns, null, area,
		...
		new Group("Buns",
				Templates.RABBIT.makeCopy("Female Bun", Game.level.squares[93][20], Game.level.factions.buns, null,
						area, new GameObject[] { Templates.MEAT_CHUNK.makeCopy(null, null) },
						new GameObject[] { Templates.FUR.makeCopy(null, null) }),
				Templates.RABBIT.makeCopy("Male Bun", Game.level.squares[94][21], Game.level.factions.buns, null, area,
						new GameObject[] { Templates.MEAT_CHUNK.makeCopy(null, null) },
						new GameObject[] { Templates.FUR.makeCopy(null, null) }),
		...
		Templates.FOX.makeCopy("Fox", Game.level.squares[200][78], Game.level.factions.foxes, null, area,
