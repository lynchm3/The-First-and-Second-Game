...
public class QuestCaveOfTheBlind extends Quest {
	...
	public void makeMortsStorage() {
		...
		Corpse carcass4 = Templates.CORPSE.makeCopy("Corpse", Game.level.squares[50][39], null, 25f);
		Corpse carcass5 = Templates.CORPSE.makeCopy("Corpse", Game.level.squares[50][39], null, 25f);
		Corpse carcass6 = Templates.CORPSE.makeCopy("Corpse", Game.level.squares[49][40], null, 25f);
		Corpse carcass7 = Templates.CORPSE.makeCopy("Corpse", Game.level.squares[49][41], null, 25f);
