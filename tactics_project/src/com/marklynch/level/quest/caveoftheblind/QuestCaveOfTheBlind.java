...
public class QuestCaveOfTheBlind extends Quest {
	...
	// Blind
	public CopyOnWriteArrayList<Blind> blind = new CopyOnWriteArrayList<Blind>(Blind.class);
	...
	public void makeCave() {
		...
		CopyOnWriteArrayList<StructureFeature> caveFeatures = new CopyOnWriteArrayList<StructureFeature>(StructureFeature.class);
		CopyOnWriteArrayList<StructurePath> cavePaths = new CopyOnWriteArrayList<StructurePath>(StructurePath.class);
		CopyOnWriteArrayList<StructureSection> caveSections = new CopyOnWriteArrayList<StructureSection>(StructureSection.class);
		...
		// West entrance room
		westEntrance = new StructureRoom("West Entrance", 225, 13, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("West Entrance <-> West Atrium", false, false,
				new CopyOnWriteArrayList<Actor>(Actor.class), Game.level.squares[238][15], Game.level.squares[239][15],
				Game.level.squares[240][15], Game.level.squares[241][15], Game.level.squares[242][15]));
		...
		// West Atrium room
		westAtriumPart1 = new StructureRoom("West Atrium", 243, 9, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(243, 9, 247, 15));
		rooms.add(westAtriumPart1);
		westAtriumPart2 = new StructureRoom("West Atrium", 243, 7, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("West Atrium <-> West Security", false, false,
				new CopyOnWriteArrayList<Actor>(Actor.class), Game.level.squares[248][7], Game.level.squares[249][7],
				Game.level.squares[250][7], Game.level.squares[251][7]));

		// West Security section
		caveSections.add(new StructureSection("Mort & Mort Mining", 244, 0, 262, 18, false, false));
		// West Security room
		westSecurity1 = new StructureRoom("West Security", 252, 4, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("West Security <-> Outer Mine", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Outer Mine room
		outerMine = new StructureRoom("Outer Mine", 255, 22, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("Outer Mine <-> Rec Room", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Rec room room
		recRoom = new StructureRoom("Rec Room", 276, 26, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(276, 26, 290, 32));
		rooms.add(recRoom);
		...
		cavePaths.add(new StructurePath("Rec Room <-> Dungeon", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				Game.level.squares[291][26], Game.level.squares[292][26], Game.level.squares[293][26],
				Game.level.squares[294][26], Game.level.squares[295][26], Game.level.squares[295][25],
				Game.level.squares[295][24], Game.level.squares[295][23], Game.level.squares[295][22],
				Game.level.squares[295][21], Game.level.squares[295][20], Game.level.squares[295][19],
				Game.level.squares[295][18], Game.level.squares[295][17], Game.level.squares[295][16],
				Game.level.squares[295][15], Game.level.squares[295][14], Game.level.squares[295][13],
				Game.level.squares[295][12], Game.level.squares[295][11], Game.level.squares[295][10],
				Game.level.squares[295][9], Game.level.squares[294][9], Game.level.squares[293][9],
				Game.level.squares[292][9], Game.level.squares[291][9], Game.level.squares[290][9],
				Game.level.squares[289][9], Game.level.squares[288][9], Game.level.squares[287][9],
				Game.level.squares[286][9], Game.level.squares[285][9], Game.level.squares[284][9],
				Game.level.squares[283][9], Game.level.squares[282][9], Game.level.squares[281][9],
				Game.level.squares[280][9], Game.level.squares[279][9], Game.level.squares[278][9],
				Game.level.squares[277][9], Game.level.squares[276][9], Game.level.squares[275][9],
				Game.level.squares[274][9]));

		// Dungeon section
		caveSections.add(new StructureSection("Mort & Mort Mining", 263, 2, 274, 18, false, false));

		// Dungeon room
		dungeon = new StructureRoom("Dungeon", 266, 7, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(265, 9, 271, 12), new RoomPart(266, 7, 273, 15), new RoomPart(268, 10, 272, 16));
		rooms.add(dungeon);
		...
		cavePaths.add(new StructurePath("Rec Room <-> Latrine", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// toilet room
		toilet = new StructureRoom("Latrine", 296, 29, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(296, 29, 298, 30), new RoomPart(299, 29, 303, 31), new RoomPart(268, 10, 272, 16));
		rooms.add(toilet);
		...
		cavePaths.add(new StructurePath("Caved In Corridor", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				Game.level.squares[289][33]));
		...
		caveIn = new StructureRoom("Caved In Corridor", 289, 35, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("Caved In Corridor", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				Game.level.squares[295][37], Game.level.squares[295][38]));

		// Path inner mine to dining room
		cavePaths.add(new StructurePath("Inner Mine <-> Dining Room", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Dining room
		diningRoom = new StructureRoom("Dining Room", 289, 39, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("Rec Room <-> Quarters", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Room Quarters
		quarters = new StructureRoom("Quarters", 276, 12, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(276, 12, 288, 21), new RoomPart(279, 13, 292, 22), new RoomPart(281, 13, 292, 23));
		rooms.add(quarters);
		...
		// Path rec room to quarters
		cavePaths.add(new StructurePath("Rec Room <-> Inner Mine", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Morts Mine Room
		mort.mortsMine = new StructureRoom("Inner Mine", 276, 36, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Morts Quarters
		mort.mortsRoom = new StructureRoom("Management", 265, 39, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Morts Vault Room
		mort.mortsVault = new StructureRoom("Vault", 249, 39, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("Dining Room <-> Equipment", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				Game.level.squares[286][51], Game.level.squares[287][51], Game.level.squares[288][51]));

		// Path Inner Mine to Equipment room
		cavePaths.add(new StructurePath("Inner Mine <-> Equipment", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Equipment room
		equipment = new StructureRoom("Equipment", 276, 52, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("Dining Room <-> Kitchen", false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		// Kitchen room
		kitchen = new StructureRoom("Kitchen", 292, 58, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
				new RoomPart(292, 58, 297, 69), new RoomPart(293, 59, 299, 72));
		rooms.add(kitchen);
		...
		cavePaths.add(new StructurePath("Dining Room <-> East Security", false, false,
				new CopyOnWriteArrayList<Actor>(Actor.class), Game.level.squares[298][51], Game.level.squares[299][51],
				Game.level.squares[299][52], Game.level.squares[299][53], Game.level.squares[300][53],
				Game.level.squares[301][53]));

		// East Security section
		caveSections.add(new StructureSection("East Security", 299, 43, 315, 56, false, false));

		// East Security room
		eastSecurity = new StructureRoom("East Security", 301, 45, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("East Security <-> East Atrium", false, false,
				new CopyOnWriteArrayList<Actor>(Actor.class), Game.level.squares[307][45], Game.level.squares[308][45],
				Game.level.squares[309][45], Game.level.squares[310][45]));

		// East Atrium Section
		caveSections.add(new StructureSection("East Atrium", 308, 36, 317, 46, false, false));

		// East Atrium Room
		eastAtrium = new StructureRoom("East Atrium", 310, 40, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cavePaths.add(new StructurePath("East Atrium <-> East Entrance", false, false,
				new CopyOnWriteArrayList<Actor>(Actor.class), Game.level.squares[315][34], Game.level.squares[315][35],
				Game.level.squares[315][36]));

		// East Entrance
		caveSections.add(new StructureSection("East Entrance", 307, 20, 321, 35, false, false));

		// East Entrance
		eastEntrance = new StructureRoom("East Entrance", 309, 30, false, false, new CopyOnWriteArrayList<Actor>(Actor.class),
		...
		cave = new Structure("Mort & Mort Mining", caveSections, rooms, cavePaths, caveFeatures,
				new CopyOnWriteArrayList<Square>(Square.class), ResourceUtils.getGlobalImage("icon_cave.png", false),
