...
public class QuestCaveOfTheBlind extends Quest {
	...
	public void makeCave() {
		...
		cavePaths.add(new StructurePath("West Entrance <-> West Atrium", false, false,
				new ArrayList<Actor>(Actor.class), Game.level.squares[238][15], Game.level.squares[239][15],
		...
		cavePaths.add(new StructurePath("West Atrium <-> West Security", false, false,
				new ArrayList<Actor>(Actor.class), Game.level.squares[248][7], Game.level.squares[249][7],
		...
		cavePaths.add(new StructurePath("Dining Room <-> East Security", false, false,
				new ArrayList<Actor>(Actor.class), Game.level.squares[298][51], Game.level.squares[299][51],
		...
		cavePaths.add(new StructurePath("East Security <-> East Atrium", false, false,
				new ArrayList<Actor>(Actor.class), Game.level.squares[307][45], Game.level.squares[308][45],
		...
		cavePaths.add(new StructurePath("East Atrium <-> East Entrance", false, false,
				new ArrayList<Actor>(Actor.class), Game.level.squares[315][34], Game.level.squares[315][35],
