...
public class QuestCaveOfTheBlind extends Quest {
	...
	public QuestCaveOfTheBlind() {
		...
		Readable rockWithEtching = Templates.ROCK_WITH_ETCHING.makeCopy(Game.level.squares[244][15],
				"Rock with message", new Object[] { "Stay out or The Blind will get you! -Mort" }, null);
	...
	public void makeCave() {
		...
		Templates.BROKEN_PLATE.makeCopy(Game.level.squares[290][40], null, true);
		Templates.BROKEN_GLASS.makeCopy(Game.level.squares[293][39], null);
		Templates.DINNER_KNIFE.makeCopy(Game.level.squares[296][52], null, false);
		Templates.DINNER_KNIFE.makeCopy(Game.level.squares[291][51], null, true);
		Templates.DINNER_FORK.makeCopy(Game.level.squares[293][46], null, true);
		Templates.DINNER_FORK.makeCopy(Game.level.squares[294][52], null, false);
		Templates.DINNER_FORK.makeCopy(Game.level.squares[293][52], null, true);
		// Chairs 1
		...
		// Chairs 2
		Templates.CHAIR.makeCopy(Game.level.squares[297][42], null, true);
		Templates.CHAIR.makeCopy(Game.level.squares[295][43], null, true);
		Templates.CHAIR.makeCopy(Game.level.squares[296][44], null, true);
		Templates.CHAIR_FALLEN.makeCopy(Game.level.squares[295][45], null, true);
		Templates.CHAIR.makeCopy(Game.level.squares[295][46], null, true);
		Templates.CHAIR.makeCopy(Game.level.squares[295][47], null, true);
		Templates.CHAIR.makeCopy(Game.level.squares[295][49], null, true);
		Templates.CHAIR_FALLEN.makeCopy(Game.level.squares[297][50], null, true);
		Templates.CHAIR_FALLEN.makeCopy(Game.level.squares[295][51], null, true);
		// Table 1
		...
		Templates.DINNER_FORK.makeCopy(Game.level.squares[294][43], null, true);
		...
		Templates.DINNER_FORK.makeCopy(Game.level.squares[294][44], null, true);
		Templates.TABLE.makeCopy(Game.level.squares[294][45], null);
		Templates.TABLE.makeCopy(Game.level.squares[294][46], null);
		Templates.DINNER_KNIFE.makeCopy(Game.level.squares[294][46], null, true);
		Templates.TABLE.makeCopy(Game.level.squares[294][47], null);
		Templates.BROKEN_PLATE.makeCopy(Game.level.squares[294][47], null, true);
		...
		Templates.DINNER_KNIFE.makeCopy(Game.level.squares[294][50], null, true);
		Templates.DINNER_FORK.makeCopy(Game.level.squares[294][50], null, true);
		...
		Templates.BED.makeCopy(Game.level.squares[277][13]);
		Templates.BED.makeCopy(Game.level.squares[279][13]);
		Templates.BED.makeCopy(Game.level.squares[281][13]);
		Templates.BED.makeCopy(Game.level.squares[283][13]);
		Templates.BED.makeCopy(Game.level.squares[285][13]);
		Templates.BED.makeCopy(Game.level.squares[287][13]);
		Templates.BED.makeCopy(Game.level.squares[277][15]);
		Templates.BED.makeCopy(Game.level.squares[279][15]);
		Templates.BED.makeCopy(Game.level.squares[281][15]);
		Templates.BED.makeCopy(Game.level.squares[283][15]);
		Templates.BED.makeCopy(Game.level.squares[285][15]);
		Templates.BED.makeCopy(Game.level.squares[287][15]);
		Templates.BED.makeCopy(Game.level.squares[289][15]);
		Templates.BED.makeCopy(Game.level.squares[291][15]);
		Templates.BED.makeCopy(Game.level.squares[277][17]);
		Templates.BED.makeCopy(Game.level.squares[279][17]);
		Templates.BED.makeCopy(Game.level.squares[287][17]);
		Templates.BED.makeCopy(Game.level.squares[289][17]);
		Templates.BED.makeCopy(Game.level.squares[291][17]);
		Templates.BED.makeCopy(Game.level.squares[277][19]);
		Templates.BED.makeCopy(Game.level.squares[279][19]);
		Templates.BED.makeCopy(Game.level.squares[287][19]);
		Templates.BED.makeCopy(Game.level.squares[289][19]);
	...
	public void makeBlind() {
		...
		// Rec Room Blind
		Blind blindRecRoom1 = Templates.BLIND.makeCopy(Game.level.squares[278][28], Game.level.factions.get(3),
				recRoom);
		blindRecRoom1.inventory.add(Templates.SERRATED_SPOON.makeCopy(null, null));
		blindRecRoom1.quest = this;
		blind.add(blindRecRoom1);

		Blind blindRecRoom2 = Templates.BLIND.makeCopy(Game.level.squares[278][30], Game.level.factions.get(3),
				recRoom);
		blindRecRoom2.inventory.add(Templates.SERRATED_SPOON.makeCopy(null, null));
		blindRecRoom2.quest = this;
		blind.add(blindRecRoom2);

		Blind blindRecRoom3 = Templates.BLIND.makeCopy(Game.level.squares[279][30], Game.level.factions.get(3),
				recRoom);
		blindRecRoom3.inventory.add(Templates.SERRATED_SPOON.makeCopy(null, null));
		blindRecRoom3.quest = this;
		blind.add(blindRecRoom3);

		Blind blindRecRoom4 = Templates.BLIND.makeCopy(Game.level.squares[280][31], Game.level.factions.get(3),
				recRoom);
		blindRecRoom4.inventory.add(Templates.SERRATED_SPOON.makeCopy(null, null));
		blindRecRoom4.quest = this;
		blind.add(blindRecRoom4);

		Blind blindRecRoom5 = Templates.BLIND.makeCopy(Game.level.squares[281][29], Game.level.factions.get(3),
				recRoom);
