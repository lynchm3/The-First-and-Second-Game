...
public class PopupMiniDialogue extends Popup {
	...
	public PopupMiniDialogue(float width, Level level, Square square) {
	...
	public void updateObjectsButtons() {
		...
		if (PopupMiniDialogue.this.square.getAllActionsPerformedOnThisInWorld(Game.level.activeActor).size() > 0)
