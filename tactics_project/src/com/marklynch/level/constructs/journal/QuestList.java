...
public class QuestList extends ArrayList<Quest> {
	...
	public void makeQuests() {
		...
		//
		// ArrayList<StructurePath> paths = new
		// ArrayList<StructurePath>(StructurePath.class);
		// ArrayList<StructureSection> structureSections = new
		// ArrayList<StructureSection>(StructureSection.class);
		// ArrayList<Square> squaresToRemove = new ArrayList<Square>(Square.class);
		// structureSections.add(new StructureSection("Puzzle Structure Section",
		// puzzleRoomsX, puzzleRoomsY,
		// puzzleRoomsX + 100, puzzleRoomsY + 150, false, false));
		//
		// ArrayList<StructureRoom> puzzleStructureRooms = new
		// ArrayList<StructureRoom>(StructureRoom.class);
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomMovingBridge(puzzleRoomsX + 1,
		// puzzleRoomsY + 1));
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomMineCart(puzzleRoomsX + 1,
		// puzzleRoomsY + 22));
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomMineCart2(puzzleRoomsX + 15,
		// puzzleRoomsY + 30));
		//
		...
		//
		// // ROOM Fallaway floor
		// puzzleStructureRooms.add(new PuzzleRoomFallawayFloor(puzzleRoomsX + 36,
		// puzzleRoomsY + 30));
		//
		...
		// PuzzleRoomMaze puzzleRoomMaze = new PuzzleRoomMaze(puzzleRoomsX + 24,
		// puzzleRoomsY + 61);
		...
		//
		// // ROOM Dig pointer
		// puzzleStructureRooms.add(new PuzzleRoomArrows(puzzleRoomsX + 6, puzzleRoomsY
		// + 92));
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomTeamwork1(puzzleRoomsX + 67,
		// puzzleRoomsY + 30));
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomTeamwork2(puzzleRoomsX + 67,
		// puzzleRoomsY + 41));
		// squaresToRemove.add(Level.squares[puzzleRoomsX + 14][puzzleRoomsY + 41]);
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomTeamwork3(puzzleRoomsX + 67,
		// puzzleRoomsY + 52));
		//
		// // ROOM Mine through walls
		// puzzleStructureRooms.add(new PuzzleRoomMineThroughWall(puzzleRoomsX + 67,
		// puzzleRoomsY + 62));
		//
		...
		//
		// // ROOM Chasm
		// puzzleStructureRooms.add(new PuzzleRoomChasm(puzzleRoomsX + 60, puzzleRoomsY
		// + 73));
		//
		...
		// puzzleStructureRooms.add(new PuzzleRoomUndergroundLake(puzzleRoomsX + 60,
		// puzzleRoomsY + 94));
		//
		// // ROOM Crumbling wall
		// puzzleStructureRooms.add(new PuzzleRoomCrumblingWall(puzzleRoomsX + 22,
		// puzzleRoomsY + 10));
		//
		// ArrayList<StructureFeature> features = new
		// ArrayList<StructureFeature>(StructureFeature.class);
		...
		// extraWalls.add(Templates.FALSE_WALL.makeCopy(Level.squares[puzzleRoomsX + 1 +
		// 1][puzzleRoomsY + 22 + 0], null));
		//
		// Structure puzzleStructure = new Structure("Puzzle Structure",
		// structureSections, puzzleStructureRooms, paths,
		// features, entrances, "building2.png", puzzleRoomsX, puzzleRoomsY,
		// puzzleRoomsX + 100,
		// puzzleRoomsY + 100, true, null, squaresToRemove, extraWalls, Templates.WALL,
