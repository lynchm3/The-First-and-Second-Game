...
public class PuzzleRoomMineCart extends StructureRoom {
	...
	public PuzzleRoomMineCart(int posX, int posY) {
		super("Minecart Room", posX, posY, false, new ArrayList<Actor>(), 1, false, new Node[] {}, new RoomPart[] {
		...
		// Test Crates
		Templates.CRATE.makeCopy("Crate", Level.squares[posX + 3][posY + 0], false, null);
		Templates.CRATE.makeCopy("Crate", Level.squares[posX + 4][posY + 0], false, null);
