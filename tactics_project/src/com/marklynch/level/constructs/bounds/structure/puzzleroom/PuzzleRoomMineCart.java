...
public class PuzzleRoomMineCart extends StructureRoom {
	...
	public PuzzleRoomMineCart(int posX, int posY) {
		...
		Templates.RAIL.makeCopy(Level.squares[posX + 11][posY + 7], null, Direction.LEFT, Direction.RIGHT);
		...
		Templates.RAIL.makeCopy(Level.squares[posX + 7][posY + 7], null, Direction.LEFT, Direction.RIGHT);
