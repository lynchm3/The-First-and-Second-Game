...
public class Area {
	...
	public Area(String name, int gridX1, int gridY1, int gridX2, int gridY2) {
		super();
		this.name = name;
		this.gridX1 = gridX1;
		this.gridY1 = gridY1;
	...
	public void draw() {
		...
		TextureUtils.drawTexture(ResourceUtils.getGlobalImage("map_cave.png"), drawPositionX1, drawPositionY1,
