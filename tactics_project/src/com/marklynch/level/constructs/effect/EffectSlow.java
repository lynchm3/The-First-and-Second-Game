...
public class EffectSlow extends Effect {
	...
	public EffectSlow(GameObject source, GameObject target, int totalTurns) {
	...
	public EffectSlow(int totalTurns) {
	...
	@Override
	public EffectSlow makeCopy(GameObject source, GameObject target) {
		return new EffectSlow(source, target, totalTurns);
	}
