...
public class ShaderLesson4 extends SimpleGame {
	...
	protected void create() throws LWJGLException {
		...
		try {
			tex0 = new Texture(Util.getResource("res/grass.png"), Texture.LINEAR, Texture.REPEAT, false);
			tex1 = new Texture(Util.getResource("res/dirt.png"), Texture.LINEAR, Texture.REPEAT, false);
			mask = new Texture(Util.getResource("res/mask.png"), Texture.LINEAR, Texture.REPEAT, false);
		} catch (IOException e) {
