...
public class TextureBlendTest extends SimpleGame {
	...
	public static final String VERT_SHADER = "uniform mat4 " + SpriteBatch.U_PROJ_VIEW + ";\n" + "attribute vec4 "
			+ SpriteBatch.ATTR_COLOR + ";\n" + "attribute vec2 " + SpriteBatch.ATTR_TEXCOORD + ";\n" + "attribute vec2 "
			+ SpriteBatch.ATTR_POSITION + ";\n" + "varying vec4 vColor;\n" + "varying vec2 vTexCoord; \n"
			+ "void main() {\n" + "	vColor = " + SpriteBatch.ATTR_COLOR + ";\n" + "	vTexCoord = "
			+ SpriteBatch.ATTR_TEXCOORD + ";\n" + "	gl_Position = " + SpriteBatch.U_PROJ_VIEW + " * vec4("
			+ SpriteBatch.ATTR_POSITION + ".xy, 0, 1);\n" + "}";

	public static final String FRAG_SHADER = "uniform sampler2D " + SpriteBatch.U_TEXTURE + ";\n" + "uniform sampler2D "
			+ TEX_ALT + ";\n" + "uniform sampler2D " + TEX_MASK + ";\n" + "varying vec4 vColor;\n"
			+ "varying vec2 vTexCoord;\n" + "void main(void) {\n" + "	vec4 texColor0 = texture2D("
			+ SpriteBatch.U_TEXTURE + ", vTexCoord);\n" + "	vec4 texColor1 = texture2D(" + TEX_ALT + ", vTexCoord);\n"
